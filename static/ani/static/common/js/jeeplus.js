    ...
    jp = {
        ...
        openUserSelectDialog: function (isMultiSelect, yesFuc) {
            top.layer.open({
                ...
                auto: true,
                maxmin: true, //开启最大化最小化按钮
                content: "/system/user/select/?isMultiSelect=" + isMultiSelect,
                btn: ['确定', '关闭'],
                yes: function (index, layero) {
        ...
        post: function (url, data, callback) {
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    if (typeof(data)=='string' && data.indexOf('login-page')>0) {//登录超时
        ...
        get: function (url, callback) {
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    if (typeof(data)=='string' && data.indexOf('login-page')>0) {//返回首页内容代表登录超时
